...
import { ArrowRight, Users, Award, BookOpen, Facebook, Linkedin, FileText } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-6xl font-bold text-slate-900 leading-tight">
                ...
                <span className="block text-blue-700">
                  How to Navigate People, Projects, and Organizational Politics
                </span>
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed">
                Helping clients strategize, focus, organize, analyze, motivate, self-motivate, and communicate directly.
                <br />
                By your side and always on your side.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-slate-900">Academic Expert</div>
                  <div className="text-slate-600 text-sm">Ben Gurion University</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center">
                ...
                <div>
                  <div className="font-semibold text-slate-900">IDF Consultant</div>
                  <div className="text-slate-600 text-sm">Resilience & Leadership</div>
                </div>
              </div>
            </div>
          </div>

          {/* Right Visual - Updated with Photo */}
          <div className="relative">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-slate-900 mb-2">Dr. Amir Nehari</h3>
              <p className="text-xl text-slate-600">Leadership Trainer & Group Facilitator</p>
            </div>
          </div>
        </div>
      </div>
